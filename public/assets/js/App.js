...
function addNewForm1() {
    ...
    var prototype = $collection1.data('prototype');
    // get the index
    // this is the index we set when the document was ready, look above for more info
    var index = $collection1.data('index');
    // create the form
    ...
    $collection1.data('index', index+1);
    // create the panel
